<template>
  <div class="promotion-container">
    <div class="promotion-title">
      JDK88 KUMPUL RESIT PROMOSI <span class="blink-text">[ HARIAN ] </span>
    </div>
...
const cards = [
  {
    title: 'In 3 Kali MYR10 FREE',
    amount: 'MYR ?',
    keperluan: [
      '<span style="color:rgb(255, 255, 0)">Topup 3 Kali </span> Claim Dengan Deposit/Topup ',
  ...
  {
    title: 'In 7 Kali MYR10 FREE',
    amount: 'MYR ?',
    keperluan: [
      '<span style="color:rgb(255, 255, 0)">Topup 6 Kali </span> Claim Dengan Deposit/Topup ',
      'Topup <span style="color:rgb(255, 255, 0)">RM10</span> Untuk Unlock Game',
      'Turnover <span style="color:rgb(255, 255, 0)">X3</span>',
      '<span style="color:rgb(255, 255, 0)">Cuci Full 100%</span>',
      'Minimum Cuci RM50 / Max Cuci RM100,000'
  ...
  {
    title: 'In 12 Kali MYR10 FREE',
    amount: 'MYR ?',
    keperluan: [
      '<span style="color:rgb(255, 255, 0)">Topup 12 Kali </span> Claim Dengan Deposit/Topup ',
      'Topup <span style="color:rgb(255, 255, 0)">RM10</span> Untuk Unlock Game',
      'Turnover <span style="color:rgb(255, 255, 0)">X3</span>',
      '<span style="color:rgb(255, 255, 0)">Cuci Full 100%</span>',
      'Minimum Cuci RM50 / Max Cuci RM100,000'
