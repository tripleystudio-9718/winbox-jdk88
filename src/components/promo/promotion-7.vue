<template>
  <div class="promotion-container">
    <div class="promotion-title">JDK88 UNLIMITED BONUS</div>
...
const cards = [
  {
    ...
    amount: '5%',
    keperluan: [
      '<span style="color:rgb(255, 255, 0)">Tidak Limit Claim </span> Setiap Hari',
      'Topup <span style="color:rgb(255, 255, 0)">RM10</span> Untuk Unlock Game',
      'Turnover <span style="color:rgb(255, 255, 0)">X1.5</span>',
  ...
  {
    title: '15% Unlimited Bonus',
    amount: '15%',
    keperluan: [
      '<span style="color:rgb(255, 255, 0)">Topup 5 Kali </span> Claim Dengan Deposit/Topup',
      'Topup <span style="color:rgb(255, 255, 0)">RM10</span> Untuk Unlock Game',
      'Turnover <span style="color:rgb(255, 255, 0)">X1.5</span>',
      '<span style="color:rgb(255, 255, 0)">Cuci FUll 100%</span>'
    ],
