<template>
  <div class="promotion-container">
    <div class="promotion-title">TELCO PIN / TNG PIN BONUS</div>
...
const cards = [
  {
    ...
    amount: 'RM2.50',
    details: [
      { text: 'Deposit RM 5 TELCO PIN untuk unlock game', type: 'success' },
      ...
      { text: 'Bonus Ini Untuk Reload Pin Sahaja : Digi | Maxis| Umobile | Celcom | TNG Pin', type: 'warning' }
    ]
  },
  {
    title: '10 PIN FREE',
    amount: 'RM5',
    details: [
      { text: 'Deposit RM 10 TELCO PIN untuk unlock game', type: 'success' },
      { text: 'Turnover X5', type: 'success' },
      { text: 'Withdraw 60%', type: 'success' },
      { text: 'Only For Slot Game', type: 'success' },
      { text: 'Unlimited Claim', type: 'success' },
  ...
  },
  {
    ...
    amount: 'RM15',
    details: [
      { text: 'Deposit RM 30 TELCO PIN untuk unlock game', type: 'success' },
      { text: 'Turnover X5', type: 'success' },
      { text: 'Withdraw 60%', type: 'success' },
      { text: 'Only For Slot Game', type: 'success' },
      { text: 'Unlimited Claim', type: 'success' },
  ...
  },
  {
    ...
    amount: 'RM25',
    details: [
      { text: 'Deposit RM 50 TELCO PIN untuk unlock game', type: 'success' },
      { text: 'Turnover X5', type: 'success' },
      { text: 'Withdraw 60%', type: 'success' },
      { text: 'Only For Slot Game', type: 'success' },
      { text: 'Unlimited Claim', type: 'success' },
  ...
  {
    title: '10 PIN UNLIMITED',
    amount: '10%',
    details: [
      { text: 'Deposit RM 10 TELCO PIN untuk unlock game', type: 'success' },
      { text: 'Turnover X5', type: 'success' },
      { text: 'Withdraw 90%', type: 'success' },
      { text: 'Only For Slot Game', type: 'success' },
      { text: 'Unlimited Claim', type: 'success' },
      { text: 'Tidak Boleh Beli Free Game / Simpan Free Game ', type: 'error' },
      { text: 'Tidak Boleh Campur / Rebate / Commision dan Lain Bonus ', type: 'error' },
...
/* not repeated here to save space since no changes were needed */
</style>
