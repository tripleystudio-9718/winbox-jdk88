...
const getSlotImageUrl = (number) => {
  try {
    // This approach works with Vite - fixed path to use slot36_part and slot36_${number}
    return new URL(`/src/assets/slot39_part/slot39_${number}.png`, import.meta.url).href;
  } catch (error) {
