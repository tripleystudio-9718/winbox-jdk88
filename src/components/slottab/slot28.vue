...
// Updated image loading function for the slot28_part images
const getSlotImageUrl = (number) => {
  try {
    // Using the slot28_part folder and correct naming convention
    return new URL(`/src/assets/slot28_part/slot28_${number}.png`, import.meta.url).href;
  } catch (error) {
...
// Initialize all game collections with slot28_part images
onMounted(() => {
  // Initialize SLOT games with images from slot28_1.png to slot28_119.png
