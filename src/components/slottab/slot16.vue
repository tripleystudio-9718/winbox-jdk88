...
// Updated image loading function for the slot16_part images
const getSlotImageUrl = (number) => {
  try {
    // Using the slot16_part folder and correct naming convention
    return new URL(`/src/assets/slot16_part/slot16_${number}.png`, import.meta.url).href;
  } catch (error) {
...
// Tab configuration
const tabs = [
  { id: 'SLOT GAME', name: 'VIDEO SLOT' },
  { id: 'ARCADE GAME', name: 'TOP GAMES' },
  { id: 'BINGO GAME', name: 'JACKPOT RACE' },
  { id: 'VIDEO GAME', name: 'FREE SPIN EVENT' },
...
onMounted(() => {
  ...
  videogame.value = videoCollection;
...
<template>
  <div>
    ...
    <div class="game-container">
      ...
      <!-- Game Grid - VIDEO GAME -->
      <div v-if="activeTab === 'VIDEO GAME'" class="games-grid">
        <div v-for="(game, index) in videogame" :key="'video-'+index" class="game-card">
          <div class="game-image">
            <img 
              :src="game.img" 
              :alt="game.alt"
