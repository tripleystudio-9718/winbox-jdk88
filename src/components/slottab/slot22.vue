...
const getSlotImageUrl = (number) => {
  try {
    // This approach works with Vite - fixed path to use slot22_part and slot22_${number}
    return new URL(`/src/assets/slot22_part/slot22_${number}.png`, import.meta.url).href;
  } catch (error) {
