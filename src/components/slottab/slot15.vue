...
// Updated image loading function for the slot15_part images
const getSlotImageUrl = (number) => {
  try {
    // Using the slot15_part folder and correct naming convention
    return new URL(`/src/assets/slot15_part/slot15_${number}.png`, import.meta.url).href;
  } catch (error) {
...
// Active tab state - Fixed to match the tab IDs
...
// Initialize all game collections with slot15_part images
onMounted(() => {
  // Initialize SLOT games with images from slot15_1.png to slot15_91.png
  ...
  boardgame.value = boardCollection;
});
...
<template>
  <div>
    ...
    <div class="game-container">
      ...
      <!-- Game Grid - BOARD GAME -->
      <div v-if="activeTab === 'BOARD GAME'" class="games-grid">
        <div v-for="(game, index) in boardgame" :key="'board-'+index" class="game-card">
          <div class="game-image">
            <img 
              :src="game.img" 
              :alt="game.alt"
