...
const getSlotImageUrl = (number) => {
  try {
    // This approach works with Vite - fixed path to use slot34_part and slot34_${number}
    return new URL(`/src/assets/slot34_part/slot34_${number}.jpg`, import.meta.url).href;
  } catch (error) {
