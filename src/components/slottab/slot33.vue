...
const getSlotImageUrl = (number) => {
  try {
    // This approach works with Vite - fixed path to use slot33_part and slot33_${number}
    return new URL(`/src/assets/slot33_part/slot33_${number}.jpg`, import.meta.url).href;
  } catch (error) {
