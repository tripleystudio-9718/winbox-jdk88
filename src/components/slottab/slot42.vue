...
// Updated image loading function for the slot42_part images
const getSlotImageUrl = (number) => {
  try {
    // Using the slot42_part folder and correct naming convention
    return new URL(`/src/assets/slot42_part/slot42_${number}.png`, import.meta.url).href;
  } catch (error) {
...
onMounted(() => {
  // Initialize SLOT games with images from slot42_1.png to slot42_128.png
  ...
  // Initialize ARCADE games with images from slot42_300.png to slot42_304.png
