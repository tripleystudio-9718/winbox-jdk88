...
// Updated image loading function for the slot7_part images
const getSlotImageUrl = (number) => {
  try {
    // Using the slot7_part folder and correct naming convention
    return new URL(`/src/assets/slot7_part/slot7_${number}.png`, import.meta.url).href;
  } catch (error) {
...
// Initialize all game collections with slot7_part images
onMounted(() => {
  // Initialize SLOT games with images from slot7_1.png to slot7_119.png
